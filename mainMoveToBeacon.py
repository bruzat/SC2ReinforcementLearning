...
def main(_):
	...
	parser.add_argument('--model_name', type=str, nargs='?', const='model', default='model', help='Name of the model')
	...
	ag = agent.Agent(model_name=model_name, model = model , rl = policyGradient.PolicyGradient, load_model=load_model)
